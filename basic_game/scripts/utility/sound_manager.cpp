...
SoundManager::SoundManager()
{
	...
	{
		MessageBox(0, L"Sound 初期化失敗", 0, MB_OK);
	}
}
...
int SoundManager::LoadSound(const std::wstring& fileName)
{
	static int iIndex = -1;
	iIndex++;
	...
	hMmio = mmioOpenA((LPSTR)narrow.c_str(), NULL, MMIO_ALLOCBUF | MMIO_READ);
...
void  SoundManager::PlaySound(int iSoundIndex, bool boLoop)
{
